...
<div class="col-md-12 ">
    <div class="ms-panel">
        <div class="ms-panel-header d-flex justify-content-between">
            ...
            <a href="{{ route('slide-notice.create') }}" class="btn btn-primary">Add Slider And Notice</a>
        </div>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <td class="d-flex text-center">
                                <a href="{{route('slide-notice.edit',$item->id)}}" data-toggle="tooltip" title="Edit" data-placement="bottom"  class=" ms-btn-icon btn-info">
                                    <i class="fas fa-edit ml-2"></i>
                                     </a>
                              <form action="{{route('slide-notice.destroy',$item->id)}}" method="POST" class="float-left ">
                                  @method('DELETE')
                                   @csrf
